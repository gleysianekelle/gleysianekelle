...
| :--- | :--- | :--- |
| **Calculadora Rosa Redonda (V3.2)** | [Acesse a Calculadora Aqui!](https://gleysianekelle.github.io/calculadora-rosa-redonda-v3.2/) | Meu primeiro projeto web! Feito com HTML, CSS (design autêntico!) e JavaScript (com função de porcentagem).
